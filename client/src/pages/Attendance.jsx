        ...
        <header className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-slate-800 pb-6">
          <div>
            ...
            <p className="text-slate-400 text-sm mt-1">
              Monitor daily punch-in times, work hours, late arrivals, and leave
              applications.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {mockAttendanceMetrics.map((stat) => {
            ...
            return (
              ...
              >
                <div
                  className={`absolute -right-8 -bottom-8 w-28 h-28 bg-gradient-to-br ${stat.color} rounded-full blur-3xl opacity-10 group-hover:opacity-30 transition-opacity duration-300`}
                />
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div
                    className={`p-2.5 rounded-xl bg-gradient-to-br ${stat.color} text-white shadow-lg ${stat.shadow} transform group-hover:scale-110 transition-transform duration-300`}
                  >
              ...
              <div className="p-4 bg-slate-950/40 border-b border-slate-800/80 flex flex-wrap items-center justify-between gap-4">
                ...
                <div className="flex flex-wrap items-center gap-3">
                  ...
                  <div className="flex items-center gap-1 bg-slate-950 border border-slate-800 rounded-xl p-1">
                    {["All", "Present", "Late", "On Leave", "Absent"].map(
                      (status) => (
                        <button
                          key={status}
                  ...
                  <tbody className="divide-y divide-slate-800/60 text-sm">
                    {filteredLogs.length > 0 ? (
                      ...
                      <tr>
                        ...
                        >
                          No attendance logs found matching the selected
                          filters.
                        </td>
                      </tr>
                    )}
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {mockLeaveRequests.map((req) => (
                  <div
                    key={req.id}
                    className="bg-slate-950/80 border border-slate-800 rounded-xl p-5 hover:border-slate-700 transition-all flex flex-col justify-between"
                  >
                    <div>
